...
const mostSummerWins = country => {
  return `SELECT year, COUNT(*) AS count FROM GoldMedal WHERE season = 'Summer' AND country = '${country}' GROUP BY 1 ORDER BY 2 DESC LIMIT 1 ` ;
};
...
const mostWinterWins = country => {
  return`SELECT year, COUNT(*) AS count FROM GoldMedal WHERE season = 'Winter' AND country = '${country}' GROUP BY 1 ORDER BY 2 DESC LIMIT 1 `;
};
...
const mostMedaledAthlete = country => {
  return `SELECT name, COUNT(DISTINCT name) AS count FROM GoldMedal WHERE country = '${country}' ORDER BY 2 DESC LIMIT 1` ;
};
